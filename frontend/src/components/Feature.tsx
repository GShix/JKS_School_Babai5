...
//                         <h2 className="mt-3 text-md sm:text-xl leading-normal text-black w-full text-justify">Our school is dedicated to fostering a love of learning and helping students achieve academic success through a rigorous and comprehensive curriculum </h2>
//                     </div>
//                 </div>
...
//                         <div className="feature-box py-3 px-2 flex flex-col items-center text-center hover:text-[#035CB0] cursor-pointer">
//                             <img className="px-2 py-2 bg-none text-[#e3d6b4] w-30 h-30 sm:w-40 sm:h-40" src={`${feature.icon}`}/>
