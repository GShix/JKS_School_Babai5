    ...
    <footer className="bg-[#ffff] w-full border-t border-gray-200">
        <div className="footer-nav flex max-sm:flex-col justify-between max-gap-10 px-6 py-5 sm:px-8 lg:px-11">
            ...
            <div className="footer-fb-page max-sm:mt-5">
                ...
                <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fjanakalyana.ma.bi.padamapura.dana&tabs=timeline&width=300&height=300&small_header=true&adapt_container_width=true&hide_cover=true&show_facepile=true&appId" width="300" height="300" scrolling="no" frameBorder="0" 
        ...
        <div className="copyright bg-[#035CB0] py-5 text-white px-4">
            <p className="w-full text-center text-sm sm:text-lg">&copy; 2025 | Janakalyan Secondary School | All Rights Reserved</p>
        </div>
    </footer>
  )
}
