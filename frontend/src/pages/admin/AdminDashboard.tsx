...
type TabType = "dashboard" | "blogs" | "gallery" | "career" | "notices" | "downloads" | "results" | "users";
...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: "notices", label: "Notices", icon: "ri-notification-3-line" },
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-1 relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-4 lg:p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-blue-100 text-xs lg:text-sm font-medium">Total Blogs</p>
                ...
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-4 lg:p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-purple-100 text-xs lg:text-sm font-medium">Gallery Images</p>
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-4 lg:p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-green-100 text-xs lg:text-sm font-medium">Job Openings</p>
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-4 lg:p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-orange-100 text-xs lg:text-sm font-medium">Notices</p>
        ...
        {activeTab === "notices" && (
          <div className="space-y-3 lg:space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 lg:mb-6">
              <h2 className="text-xl lg:text-2xl font-bold">Manage Notices</h2>
              <button className="w-full sm:w-auto px-3 lg:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm lg:text-base">
                <i className="ri-add-line mr-2"></i>Add Notice
              </button>
            </div>
            <div className="bg-white rounded-lg shadow overflow-x-auto">
              <table className="w-full text-sm lg:text-base">
