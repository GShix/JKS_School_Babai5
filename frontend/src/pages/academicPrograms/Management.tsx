				...
				<div className="container mx-auto px-4 sm:px-10 py-2 grid grid-cols-1 lg:grid-cols-12 gap-8 mb-5">
					...
					<div className="lg:col-span-8">
						...
						<div className="prose max-w-none text-gray-700 text-justify">
							...
							<ol className="list-decimal pl-6 mt-4 space-y-2">
								...
								<li><strong>Management</strong> <span className="text-gray-500">(Subject Code: 5011)</span></li>
								<li><strong>Social Studies and Life Skills Management</strong> <span className="text-gray-500">(Subject Code: 5031)</span></li>
								<li>
					...
					<aside className="lg:col-span-4">
						<div className="bg-white rounded-md shadow-sm overflow-hidden mb-6">
							<img src="/img/aca-management.jpg" alt="Management" className="w-full h-40 object-cover" />
							<div className="p-4">
								...
								<div className="flex items-center justify-between">
									...
									<div className="text-gray-800">Management</div>
								</div>
							</div>
						</div>
