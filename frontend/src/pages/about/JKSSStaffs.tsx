...
const JKSSStaffs = () => {
  ...
  // Define position hierarchy for non-teaching staff
  const positionHierarchy = [
    ...
    { position: 'Security Guard', title: 'Security Staff', single: false },
    { position: 'Cleaner', title: 'Cleaning Staff', single: false },
    { position: 'Cook', title: 'Kitchen Staff', single: false },
    { position: 'Driver', title: 'Transport Staff', single: false },
  ];
      ...
      <main className="min-h-screen">
        ...
        <div className="staff-content w-full mx-auto px-4 py-8 sm:px-6 md:px-10 lg:px-16 max-w-7xl">
          {loading ? (
            ...
            <div className="text-center py-20">
              <p className="text-gray-600">No staff members to display</p>
            </div>
          ) : (
