...
exports.getAllBlogs = async (req, res) => {
    try {
        ...
        if (status) whereClause.blogStatus = status;
        if (category) whereClause.blogCategory = category;
...
// Fetch single blog by id (admin view — any status)
exports.getAdminSingleBlog = async (req, res) => {
    const { id } = req.params;
    try {
...
// Delete blog (soft delete = archive, or permanent)
